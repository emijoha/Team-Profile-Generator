...
1. In the main directory, open the terminal.
    ...
    <img src="./README-images/openTerminal.png" alt="open terminal" width="400"/>

2. Run `node app.js`

    <img src="./README-images/appStart.png" alt="start the app" width="400"/>
...
4. When finished, the user will be asked which new member they would like to add to the team (An engineer, intern, or none).
    ...
    <img src="./README-images/addEngineer.png" alt="prompts about the team manager, option to add engineer selected" width="400"/>
...
5. If the 'engineer' choice is selected, the user will be prompted to enter the name, id, and email contact for that the engineer, as well as their github username.
     ...
     <img src="./README-images/addIntern.png" alt="prompts about the engineer, option to add intern selected" width="400"/>
...
6. If the 'intern' choice is selected, the user will be prompted to enter the name, id, and email contact for that intern, as well as the school they attend.
    ...
    <img src="./README-images/TeamDone.png" alt="prompts about the intern, option to stop adding team members selected" width="400"/>
...
8. A message appears confirming the team.html webpage has been made and saved to the 'output' folder. 
    ...
    <img src="./README-images/Output.png" alt="message appears that says 'File team.html' added, and file appears in output folder" width="400"/>
...
9. If exporting this file to another repo for deployment or other reason, make sure to also export the style.css file in the 'output' folder. This will insure the webpage retains all its styling. Below is an example of the generated webpage.
    ...
    <img src="./README-images/exOutput.png" alt="webpage displaying information about a software engineering team" width="400"/>
...
<img src="./README-images/testPass.png" alt="test results logged in terminal that show that all tests passed" width="400"/>

## Questions

Feel free to reach out to me with any questions or comments!

<img src="https://avatars0.githubusercontent.com/u/60240293?v=4" alt="Image of Emilia Josefina Hartline" width="200"/>
